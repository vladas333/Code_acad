...
# Base class should contain methods to get:  plane name, plane type 
# (A320, B737 etc), max_speed (should be the funciotn: base_speed * model_speed_coeficient).
...
print(my_plane._get_type_speed_coef())